...
from dpattack.libs.nlpaug import CharAugmenter
from dpattack.libs.nlpaug import Action, Method
import dpattack.libs.nlpaug.model.char as nmc
...
class KeyboardAug(CharAugmenter):
    ...
    >>> from dpattack.libs import nlpaug as nac
    >>> aug = nac.KeyboardAug()
    """
